...
class UserQuake3ServerConfiguration(BaseModel):
    ...
    def password(self) -> str:
        ...
        return Fernet(CONFIG.RCON_PASSWORD_FERNET_KEY).decrypt(self.encrypted_password.encode()).decode()
    ...
    async def create(
        ...
        from bot.config import CONFIG
        kwargs["encrypted_password"] = Fernet(CONFIG.RCON_PASSWORD_FERNET_KEY).encrypt(kwargs.pop("password").encode()).decode()
